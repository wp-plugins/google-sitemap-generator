...
class GoogleSitemapGeneratorUI {
	...
	function HtmlShowOptionsPage() {
		...
		a.sm_donatePayPal {
			background-image:url(<?php echo $this->sg->GetPluginUrl(); ?>/icon-paypal.gif);
		}
		
		a.sm_donateAmazon {
			background-image:url(<?php echo $this->sg->GetPluginUrl(); ?>/icon-amazon.gif);
		}
		
		a.sm_pluginHome {
			background-image:url(<?php echo $this->sg->GetPluginUrl(); ?>/icon-arne.gif);
		}
		
		a.sm_pluginList {
			background-image:url(<?php echo $this->sg->GetPluginUrl(); ?>/icon-email.gif);
		}
		
		a.sm_pluginSupport {
			background-image:url(<?php echo $this->sg->GetPluginUrl(); ?>/icon-wordpress.gif);	
		}
		
		a.sm_pluginBugs {
			background-image:url(<?php echo $this->sg->GetPluginUrl(); ?>/icon-trac.gif);	
		}
		
		a.sm_resGoogle {
			background-image:url(<?php echo $this->sg->GetPluginUrl(); ?>/icon-google.gif);	
		}
		
		a.sm_resYahoo {
			background-image:url(<?php echo $this->sg->GetPluginUrl(); ?>/icon-yahoo.gif);	
		}
						...
						<div id="grabit" class="dbx-group">
							...
							<fieldset id="dm_donations" class="dbx-box">
								...
								<div class="dbx-content">
									...
									<?php } ?>
									<a style="float:left; margin-right:5px; border:none;" href="javascript:document.getElementById('sm_donate_form').submit();"><img style="vertical-align:middle; border:none; margin-top:2px;" src="<?php echo $this->sg->GetPluginUrl(); ?>/icon-donate.gif" border="0" alt="PayPal" title="Help me to continue support of this plugin :)" /></a>
