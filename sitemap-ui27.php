...
/*
 ...
 $Id: sitemap-ui.php 76139 2008-11-27 14:45:20Z arnee $

*/

class GoogleSitemapGeneratorUI27 {

	var $sg = null;

	function GoogleSitemapGeneratorUI27($sitemapBuilder) {
				...
				<div id="poststuff" class="metabox-holder">
					<div class="inner-sidebar">
						<div id="side-sortables" class="meta-box-sortabless ui-sortable" style="position:relative;">
							<div id="sm_pnres" class="postbox">
								...
								<h3 class="hndle"><span><?php _e('About this Plugin:','sitemap'); ?></span></h3>
								<div class="inside">
							...
							<div id="sm_smres" class="postbox">
								...
								<h3 class="hndle"><span><?php _e('Sitemap Resources:','sitemap'); ?></span></h3>
								<div class="inside">
							...
							<div id="dm_donations" class="postbox">
								
								<h3 class="hndle"><span><?php _e('Recent Donations:','sitemap'); ?></span></h3>
								<div class="inside">
					...
					<div class="has-sidebar sm-padded" >
						...
						<div class="postbox">
							...
							<h3 class="hndle"><?php _e('Status', 'sitemap') ?></h3>
							<div class="inside">
								<ul>
									<?php
						...
						<!-- Basic Options -->
						<div class="postbox">
							<h3 class="hndle"><?php _e('Basic Options', 'sitemap') ?></h3>
							<div class="inside">
						...
						<div class="postbox">
							...
							<h3 class="hndle"><?php _e('Additional pages', 'sitemap') ?></h3>
							<div class="inside">
								<?php
						...
						<div class="postbox">
							...
							<h3 class="hndle"><?php _e('Post Priority', 'sitemap') ?></h3>
							<div class="inside">
						...
						<div class="postbox">
							...
							<h3 class="hndle"><?php _e('Location of your sitemap file', 'sitemap') ?></h3>
							<div class="inside">
								<div>
						...
						<div class="postbox">
							...
							<h3 class="hndle"><?php _e('Sitemap Content', 'sitemap') ?></h3>
							<div class="inside">
								<ul>
									<li>
						...
						<div class="postbox">
							...
							<h3 class="hndle"><?php _e('Excluded items', 'sitemap') ?></h3>
							<div class="inside">
						...
						<div class="postbox">
							...
							<h3 class="hndle"><?php _e('Change frequencies', 'sitemap') ?></h3>
							<div class="inside">
								<p>
						...
						<div class="postbox">
							...
							<h3 class="hndle"><?php _e('Priorities', 'sitemap') ?></h3>
							<div class="inside">
								<ul>
									<li>
